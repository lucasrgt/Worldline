...
<p align="center">
  <img src="https://img.shields.io/badge/milestone-v1.460.0%20M555%20GO-2EA44F?style=flat-square" alt="Worldline v1.460.0 M555 GO">
...
The official main line is **Worldline v1.460.0 / M555**. Its stable foundation
...
| M111-M566 | Official vanilla world, block, item, entity, crafting, AI, damage, death, piston, portal-scale, spawn-light, grass-spread, and torch-burnout sets | GO |
| M555 | Current release: official redstone-torch burnout to unlit then recover | GO |
