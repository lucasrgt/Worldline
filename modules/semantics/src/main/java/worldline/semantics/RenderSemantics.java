...
final class RenderSemantics {
    ...
    static List<SemanticMapping> mappings() {
        return Collections.unmodifiableList(Arrays.asList(
                ...
                SemanticMapping.of("render", "COMPASS_TEXTURE",
                        "net/minecraft/src/TextureCompassFX", "class", "TextureCompassFX", "-",
                        "WORLD,PLAYER", "RENDER", "RENDER",
                        "controlled-client-tick,symbols.map", "", 9990),
                SemanticMapping.of("render", "COMPASS_ANGLE",
                        "net/minecraft/src/TextureCompassFX", "field", "field_4229_i", "D",
                        "WORLD,PLAYER", "RENDER", "RENDER",
                        "controlled-client-tick,symbols.map", "i", 9990),
                SemanticMapping.of("render", "COMPASS_VELOCITY",
                        "net/minecraft/src/TextureCompassFX", "field", "field_4228_j", "D",
                        "WORLD,PLAYER", "RENDER", "RENDER",
                        "controlled-client-tick,symbols.map", "j", 9990),
                SemanticMapping.of("render", "TEXTURE_EFFECT",
                        "net/minecraft/src/TextureFX", "class", "TextureFX", "-",
                        "", "RENDER", "RENDER", "controlled-client-tick,symbols.map", "", 9990),
                SemanticMapping.of("render", "TEXTURE_PIXELS",
                        "net/minecraft/src/TextureFX", "field", "imageData", "[B",
                        "RENDER", "RENDER", "RENDER",
                        "controlled-client-tick,symbols.map", "a", 9990),
                SemanticMapping.of("render", "TEXTURE_EFFECT_TICK",
                        "net/minecraft/src/TextureFX", "method", "onTick", "()V",
                        "WORLD,PLAYER", "RENDER", "RENDER",
                        "controlled-client-tick,symbols.map", "a", 9990)));
    }
}
