...
/** Canonical public observation of the native fire lifecycle. */
public final class FireSubsystemObservation {
    private final String domains, lifecycle, persistence, physics, timing, neighbors;
    public FireSubsystemObservation(String domains, String lifecycle, String persistence,
    ...
    @Override public boolean equals(Object other) {
        if (!(other instanceof FireSubsystemObservation))
            return false;
        FireSubsystemObservation value = (FireSubsystemObservation) other;
