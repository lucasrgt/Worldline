...
/** Canonical public observation of the native locked-chest lifecycle. */
public final class LockedChestSubsystemObservation {
    private final String domains, lifecycle, persistence, physics, timing, neighbors;
    public LockedChestSubsystemObservation(String domains, String lifecycle, String persistence,
    ...
    @Override public boolean equals(Object other) {
        if (!(other instanceof LockedChestSubsystemObservation))
            return false;
        LockedChestSubsystemObservation value = (LockedChestSubsystemObservation) other;
