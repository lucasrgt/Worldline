...
/** Equatable canonical evidence for the native bedrock subsystem. */
public final class BedrockSubsystemEvidence {
    private final BedrockSubsystemObservation observation;
    public BedrockSubsystemEvidence(BedrockSubsystemObservation observation) {
        this.observation = Objects.requireNonNull(observation, "observation");
    }
    public BedrockSubsystemObservation observation() {
        return observation;
    }
    public String canonical() {
        StringBuilder value = new StringBuilder("schema=worldline.bedrock-subsystem-evidence.v1\n");
        value.append("subject=b1.7.3:block/007\n");
    ...
    @Override public boolean equals(Object other) {
        return other instanceof BedrockSubsystemEvidence
                && observation.equals(((BedrockSubsystemEvidence) other).observation);
    }
