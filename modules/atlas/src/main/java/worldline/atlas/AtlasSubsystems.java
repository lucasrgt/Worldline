...
public final class AtlasSubsystems {
    public static final String[] ALL = { "tick-lifecycle", "worldgen", "chunks", "lighting",
            ...
            "dedicated-server", "profiling", "rendering", "animation", "gui", "resources",
    ...
    private static Map<String, String> domains() {
        ...
        assign(mapped, "runtime", "protocol", "dedicated-server", "profiling", "rendering",
                "animation", "gui", "resources");
    ...
    private static Map<String, String> categories() {
        ...
        mapped.put("mod-ecosystem", "mod-ecosystem");
        mapped.put("mod_ecosystem", "mod-ecosystem");
        mapped.put("render", "rendering");
        mapped.put("animation", "animation");
        mapped.put("gui", "gui");
