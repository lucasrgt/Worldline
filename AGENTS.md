...
1. Maintained product code must remain at or below 1,350 `tokei` code lines,
...
3. Executable smoke scenarios and oracle adapters must remain at or below 1,250
