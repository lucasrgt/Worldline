...
`flush` calls made in each retained renderer interval. The renderer and queue
spans are nested and must not be added together.
...
every record. Renderer medians were `50100` and `48500 ns`; queue medians were
