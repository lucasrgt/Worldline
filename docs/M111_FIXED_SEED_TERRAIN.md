...
M111 therefore widens the read-only view distance to seven and addresses the
world by absolute chunk coordinate. Spawn pose is printed only as diagnostics
and cannot affect the semantic signature.
