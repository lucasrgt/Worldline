...
positional hash. Mushroom decorations 39/40 are excluded after fresh-world
diagnostics demonstrated generation-order variation.
...
lighting, decoration determinism, or a general dimension API.
