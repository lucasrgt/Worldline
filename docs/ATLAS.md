...
the public TestKit. The entity family has 38 lifecycle, materialization, and controlled-dynamics
claims on `surface-public-testkit`, 15 remaining qualified historical proofs on
`surface-smoke-only`, and 211 explicit unknown cells. Every public entity claim is
