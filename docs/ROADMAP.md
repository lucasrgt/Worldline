...
## Immediate post-v1.54.0 direction

The next milestone can extend combat into death/respawn or add a real-client
render capture around this event seam, while generic combat, crafting, merging,
shift clicks, and broad container automation remain outside the stable contract.
