...
## Immediate post-v1.49.0 direction

The next milestone can add the asymmetric workbench layout (Packet100 declares
9 matrix slots while Packet104 contains result + matrix + player tail) before
any 3x3 recipe write. This still does not imply generic recipes or merges.
