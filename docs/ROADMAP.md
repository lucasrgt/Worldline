...
| v0.8.0 / AERO-M10 (legacy M10) | Native/offscreen render E2E and Aero investigation | GO - render stable; Aero artifact absent |
| v0.9.0 / AERO-M11 (legacy M11) | Render-work attribution and exact Aero qualification | GO - bounded attribution and StationAPI load |
| v1.0.0 / AERO-M12 (legacy M12) | Real Aero scene capture, repeated spike classification, and evidence minimization | GO - chunk-compilation spike reproduced; persistence split deferred |
| v1.1.0 / AERO-M13 (legacy M13) | Aero persistence isolation, dense/empty differential, and compile-budget test | GO - real BEs persist; empty retains compile pressure; budget rejected |
| v1.2.0 / AERO-M14 (legacy M14) | Chunk caller semantics, initial-backlog attribution, and bounded non-retry policy | GO - caller/backlog isolated; policy experimental |
| v1.3.0 / AERO-M15 (legacy M15) | Explicit accepted/deferred contract, visible readiness, and geometry oracle | GO - contract qualified; fixed batch experimental |
| v1.4.0 / AERO-M16 (legacy M16) | Visible-first adaptive chunk envelope and fixed-state framebuffer oracle | GO - scheduler qualified; post-overlay visual divergence |
| v1.5.0 / AERO-M17 (legacy M17) | Three-scenario scheduler hardening and upstream evaluation profile | GO - matrix complete; promotion NO-GO |
| v1.6.0 / AERO-M18 (legacy M18) | Save/GC/compile attribution of the historical random spike | GO - timeline colocated; spike NON-CLAIM |
| v1.7.0 / AERO-M19 (legacy M19) | Forced dirty-set autosave and opt-in one-chunk save cap | GO - synthetic hitch bounded; cap default-off |
...
| v1.300.0 / M312 | Torch invert | GO - redstone torch 76:4 inverts to 75:4 |
| v1.301.0 / M313 | Note instruments | GO - Packet54 instruments 1,4,2 on stone/wood/sand |
| v1.302.0 / M314 | Armor crafts | GO - iron helmet 306, chest 307, legs 308, boots 309 |
| v1.303.0 / M315 | Dye wool crafts | GO - white wool plus dyes to 35:14, 35:13, 35:11 |
| v1.304.0 / M316 | Shears set | GO - shears leaves 18 and living sheep wool 35 |
| v1.305.0 / M317 | Slow blocks | GO - cobweb 30 and soul sand 88 pose slowdown |
| v1.306.0 / M318 | Gold diamond tool crafts | GO - gold 283-286 and diamond 276-279 tools |
| v1.307.0 / M319 | Stair slab crafts | GO - oak stairs 53, cobble stairs 67, stone slab 44 |
| v1.308.0 / M320 | Leather armor crafts | GO - leather helm 298, chest 299, legs 300, boots 301 |
| v1.309.0 / M321 | Gold armor crafts | GO - gold helm 314, chest 315, legs 316, boots 317 |
| v1.310.0 / M322 | Diamond armor crafts | GO - diamond helm 310, chest 311, legs 312, boots 313 |
| v1.311.0 / M323 | Iron tool crafts | GO - iron sword 267 pick 257 shovel 256 axe 258 hoe 292 |
| v1.312.0 / M324 | Furnace rest smelts | GO - sand 12→20 cobble 4→1 fish 349→350 |
| v1.313.0 / M325 | Navigation crafts | GO - compass 345, clock 347, empty map 358 |
| v1.314.0 / M326 | Vehicle crafts | GO - boat 333, minecart 328, chest cart 342, furnace cart 343 |
| v1.315.0 / M327 | Food crafts | GO - stew 282, bread 297, cookies 357, cake 354 |
| v1.316.0 / M328 | Dye family crafts | GO - bone meal, rose red, dandelion yellow, gray dye |
| v1.317.0 / M329 | Utility block crafts | GO - fence 85, ladder 65, bookshelf 47 |
| v1.318.0 / M330 | Bed sleep set | GO - occupy 26:8→26:12 then wake standing |
| v1.319.0 / M331 | Throwables set | GO - Packet23 types 61 snowball, 62 egg, 90 hook |
| v1.320.0 / M332 | Bow arrow set | GO - crafts 261+262 then Packet23 type 60 |
...
| v1.335.0 / M347 | Gold diamond hoes | GO - gold hoe 294 and diamond hoe 293 |
| v1.336.0 / M348 | Dye mix crafts | GO - orange 351:14, purple 351:5, lime 351:10 |
| v1.337.0 / M349 | Double chest set | GO - adjacent 54 cells open Large chest 54 slots |
| v1.338.0 / M350 | Sign text set | GO - standing 63 and wall 68 Packet130 text |
| v1.339.0 / M351 | Painting orient set | GO - Packet25 west dir1 and east dir3 |
| v1.340.0 / M352 | Tool durability set | GO - picks 270, 257, 285 remaining damage |
| v1.341.0 / M353 | Sword damage set | GO - wood 268, iron 267, diamond 276 pig hits |
| v1.342.0 / M354 | Farmland hydrate set | GO - dry 60:0 and hydrated 60:7 |
| v1.343.0 / M355 | Note rest instruments | GO - glass instrument 3 and gold instrument 0 |
...
| v1.348.0 / M360 | Fishing catch set | GO - rod 346 Packet23 type 90 then Packet21 fish 349 |
...
| v1.360.0 / M372 | Placeable item crafts | GO - painting 321, sign 323, bowl 281 |
| v1.361.0 / M373 | Milk bucket set | GO - cow fill 325 to 335 then drink back to 325 |
| v1.362.0 / M374 | Remaining food eat | GO - apple 260, pork 320, golden apple 322 heals |
| v1.363.0 / M375 | Remaining pick breaks | GO - mossy 48, gold ore 14, obsidian 49 |
| v1.364.0 / M376 | Remaining shovel breaks | GO - clay 82, snow 78/80, soul sand 88 |
| v1.365.0 / M377 | Powered rail motion | GO - powered 27:8 and detector 28:8 with cart type 10 |
| v1.366.0 / M378 | Boat water set | GO - boat type 1 spawn plus Packet39 ride and detach |
| v1.367.0 / M379 | Iron door set | GO - iron door 71 halves powered by lever 69 |
...
| v1.376.0 / M388 | Hostile drops set | GO - zombie feather 288 and skeleton arrow 262 |
| v1.377.0 / M389 | Animal drops set | GO - cow leather 334 and chicken feather 288 |
| v1.378.0 / M390 | Remaining spawner set | GO - creeper type 50 and spider type 52 |
| v1.379.0 / M391 | Creeper explode set | GO - creeper Packet60 strength 3 on dirt and wool |
| v1.380.0 / M392 | Remaining fluid flow | GO - still water 9 and still lava 11 horizontal flow |
| v1.381.0 / M393 | Stair facing set | GO - oak 53 and cobble 67 look-yaw facings |
| v1.382.0 / M394 | Remaining slab place | GO - sandstone, wood, cobble, and double slabs |
| v1.383.0 / M395 | Remaining dye mix | GO - cyan, pink, and light-blue 2x2 mixes |
| v1.384.0 / M396 | Remaining wool crafts | GO - magenta, light-blue, and lime dyed wool |
| v1.385.0 / M397 | Dispenser projectiles | GO - dispenser snowball 61 and egg 62 |
| v1.386.0 / M398 | Jukebox eject set | GO - gold 2256 and cat 2257 Packet21 eject |
| v1.387.0 / M399 | Wooden button set | GO - stone button 77 four wall faces |
...
| v1.392.0 / M404 | Remaining cart break | GO - type 10 drops 328 and type 11 drops 328+54 |
| v1.393.0 / M405 | Pig saddle set | GO - pig type 90 saddle 329 consume plus Packet39 mount |
| v1.394.0 / M406 | Sheep dye set | GO - rose-red and yellow living-sheep wool |
| v1.395.0 / M407 | Chicken egg set | GO - chicken type 93 plus egg 344 / type 62 |
| v1.396.0 / M408 | Squid ink set | GO - squid type 94 in water plus ink sac 351:0 |
| v1.397.0 / M409 | Spider string set | GO - spider type 52 string 287 plus cobweb 30 |
...
| v1.406.0 / M419 | Remaining netherrack place | GO - nether 87 plus soul sand 88 plus glowstone 89 |
| v1.407.0 / M413 | Fire spread set | GO - netherrack fire 51 onto planks 5, leaves 18, wool 35 |
| v1.408.0 / M433 | Remaining chest orient | GO - isolated look-yaw 54 plus EW and NS pairs |
| v1.409.0 / M434 | Remaining sponge glass ice | GO - sponge 19 plus glass 20 plus ice 79 |
...
| v1.414.0 / M424 | Furnace cart motion | GO - type 12 coal push plus detector 28:8 |
| v1.415.0 / M425 | Remaining machine faces | GO - dispenser 23, furnace 61, pumpkin 86 facings |
| v1.416.0 / M426 | Remaining redstone faces | GO - lever 69 wall/ground plus repeater 93/94 delay-facing |
...
| v1.421.0 / M431 | Remaining bed orient | GO - bed 26 remaining west/north/east halves |
...
| v1.426.0 / M439 | Remaining ore place | GO - coal 16 plus lapis 21 plus unlit redstone 73 |
| v1.427.0 / M440 | Remaining dye rest | GO - remaining 2x2 dye mixes 351:7 and 351:13 |
| v1.428.0 / M442 | Remaining record place | GO - two jukebox 84 plus discs 2256 and 2257 |
...
| v1.435.0 / M453 | Player death drops | GO - void Packet8 0 plus hotbar 1+4+3 Packet21 |
| v1.436.0 / M454 | Peaceful despawn | GO - difficulty 0 absent vs easy 50+54 persist |
| v1.437.0 / M455 | Melee pursuit set | GO - types 54 and 51 Packet31/33/34 toward pose |
| v1.438.0 / M448 | Creeper fuse set | GO - type 50 Packet40 state 1 then Packet60 |
...
| v1.443.0 / M460 | Monster bed interrupt | GO - occupy 26:12 then type 54 leave 26:8 |
...
| v1.448.0 / M546 | Piston QC set | GO - power-above 33:4->12 then retract, piston cell unpowered |
...
## Platform and dev-tools line

Parallel to the vanilla milestone sequence, a platform and dev-tools line
lands named, numbered-free capabilities on top of the same evidence rules:

| Capability | Status |
| --- | --- |
| Mod API v2: lifecycle hooks, M3 domain handles, scheduling, spawn/give surface | GO - stable milestone |
