...
## Immediate post-v1.111.0 direction
...
M123's first cross-chunk causal transition into recovery paths, additional
physics, world-generation breadth, entity AI, dimensions
