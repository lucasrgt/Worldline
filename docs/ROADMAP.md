...
## Immediate post-v1.48.0 direction

The next milestone can extend bounded container work to retrieval or workbench
recipes while retaining the same fail-closed lifecycle. This still does not
imply generic recipes, shift/right click, arbitrary merges, or complete physics.
