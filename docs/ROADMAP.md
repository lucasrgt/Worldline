...
## Immediate post-v1.103.0 direction
...
sequence now deepens fluid behavior and advances from M115's redstone
component state into observable signal propagation, then world-generation
breadth, entity AI, dimensions and persistence/multiplayer composition.
