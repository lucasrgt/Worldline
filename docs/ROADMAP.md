...
## Immediate post-v1.134.0 direction
...
M146 proves official rejection of one immovable obsidian payload. The next
useful piston boundary is the exact twelve-block push capacity and its
thirteen-block rejection, not another small-chain increment.
