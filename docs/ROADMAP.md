...
## Immediate post-v1.29.0 direction

The next milestone can add a caller-supplied opaque correlation value to route
events and terminal summaries, preserving synchronous execution and avoiding a
global registry. Packet control still does not imply server tick control,
