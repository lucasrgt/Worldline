...
## Immediate post-v1.21.0 direction

The next milestone consumes server position corrections into the neutral pose,
then qualifies vertical movement and collision-sensitive traversal without
losing cache coherence. Packet control still does not imply server tick control.
