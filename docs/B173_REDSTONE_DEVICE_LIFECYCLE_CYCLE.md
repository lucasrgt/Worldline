# B173-REDSTONE-DEVICE-LIFECYCLE-CYCLE official Beta 1.7.3 redstone device lifecycle family

<!-- Generated from smoke.properties by MilestoneNarrative. -->

## Claim

One public TestKit family executes unpowered redstone wire, an unpowered repeater, and a closed east-face trapdoor against the unmodified official Beta 1.7.3 server. Three isolated rows prove item-to-block placement, exact initial metadata, two fresh-login boundaries, break to air, exact historical item drops, and an unchanged stick.
