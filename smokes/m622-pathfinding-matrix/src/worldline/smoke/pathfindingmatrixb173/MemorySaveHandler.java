...
/** Removes persistence while preserving the official pathfinder world boundary. */
@SuppressWarnings("rawtypes")
final class MemorySaveHandler implements ISaveHandler, IPlayerFileData {
  private final WorldInfo info;
  private final MemoryChunkLoader chunks;

  MemorySaveHandler(long seed, String name, int terrain) {
    info = new WorldInfo(seed, name);
    info.setSpawnPosition(8, 64, 8);
    chunks = new MemoryChunkLoader(terrain);
  }
