  ...
  public static void write() {
    if (written || !WorldlinePagedBridge.sealed() || !WorldlineTopologyEvent.valid())
      throw new IllegalStateException(
          "invalid M83 write state " + WorldlineTopologyEvent.diagnostic());
    ...
    try {
      ...
      System.out.println("[WorldlineTopology] complete requestIndex="
          ...
          + " topology=" + Integer.getInteger("worldline.topology.code", 0) + " targets=2 rebuilds="
          + WorldlineTopologyEvent.expectedRebuilds() + " bytes=" + b.length + " sha256=" + h);
    } catch (IOException | NoSuchAlgorithmException e) {
      throw new IllegalStateException("M83 artifact write failed", e);
    }
  }
}
