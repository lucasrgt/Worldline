...
public final class ServerControlSmoke {
    ...
    public static void main(String[] arguments) throws Exception {
        ...
        B173DedicatedServer runtime = new B173DedicatedServer(jar, workspace, port, seed, Duration.ofSeconds(90));
        ServerState saved;
        try {
            runtime.boot();
            ServerState running = runtime.state();
            require(running.lifecycle() == ServerLifecycle.RUNNING && !running.onlineMode(), "boot state drift");
        ...
        System.out.println("WORLDLINE_M21_SOURCE=" + B173DedicatedServer.class.getProtectionDomain()
