...
public final class WorldlineWaterDownwardFlowOracle {
    ...
    private static void run(CanonicalTrace trace, String label, int fixture) {
        ...
        if (fixture == OracleMemoryChunkLoader.BLOCKED) {
            ...
            require(water(world.a(X, 67, Z)) && water(world.a(X, 65, Z))
                    && world.a(X, 64, Z) == na.u.bn, "open column did not flow to its floor");
        } else require(water(world.a(X, 64, Z)) && water(world.a(X, 61, Z)),
    ...
    private static boolean water(int id) { return id == na.B.bn || id == na.C.bn; }
