...
final class WaterWorldBackend implements GameBackend {
    ...
    WaterWorldBackend(long seed, int fixture) { this.seed = seed; this.fixture = fixture; }
    ...
    @Override public void loadWorld(WorldSource source) {
        ...
        require(world.setBlockAndMetadataWithNotify(X, SOURCE_Y, Z,
                Block.waterMoving.blockID, 0), "water source placement failed");
    }
    ...
    void assertOutcome() {
        ...
        if (fixture == MemoryChunkLoader.BLOCKED) {
            require(id(67) == Block.stone.blockID && id(66) == 0,
        ...
        } else require(water(id(64)) && water(id(61)),
                "shaft did not carry water below the removed floor");
    }

    private int id(int y) { return requireWorld().getBlockId(X, y, Z); }
