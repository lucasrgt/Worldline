...
public final class B173StairSlabCrafts {
    ...
    public static void apply(B173WireClient actor) {
        try { new B173StairSlabCrafts(actor).run(); }
        catch (IOException error) { throw new IllegalStateException("stair-slab crafts failed", error); }
    }
    ...
    private void run() throws IOException {
        ...
        craft(38, item(5, 6, 0), STAIRS, new RemoteItemStack[] {null, null, null, null, null, OAK}, OAK);
        craft(39, item(4, 6, 0), STAIRS, new RemoteItemStack[] {null, null, null, null, null, COBBLE}, COBBLE);
    ...
    private void craft(int personal, RemoteItemStack ingredient, int[] cells,
        ...
        int combined = personal + 1; pickup(combined, personal, ingredient);
