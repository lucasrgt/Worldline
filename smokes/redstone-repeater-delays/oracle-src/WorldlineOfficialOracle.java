...
public final class WorldlineOfficialOracle {
  ...
  public static void main(String[] arguments) {
    ...
    for (int index = 0; index < Z.length; index++) {
      ...
      require(world.b(REPEATER_X, Y, Z[index], na.bi.bn, META[index]), "repeater placement failed");
    }
  ...
  private static void snapshot(CanonicalTrace trace, String label, dj world) {
    trace.record(label, world.m(), world.b.size(), world.a(REPEATER_X, Y, Z[0]),
        world.a(REPEATER_X, Y, Z[1]), world.a(REPEATER_X, Y, Z[2]));
  }
