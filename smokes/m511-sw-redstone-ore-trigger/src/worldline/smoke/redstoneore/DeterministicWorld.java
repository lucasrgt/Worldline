...
final class DeterministicWorld extends World{
 DeterministicWorld(ISaveHandler save,String name,long seed){super(save,name,seed,null);}
 void freezeRandom(long seed){distHashCounter=(int)seed;rand.setSeed(seed);}
}
