...
public final class WorldlinePairBlock extends TemplateBlockWithEntity {
    public WorldlinePairBlock(Identifier identifier) {
        super(identifier, Material.STONE); setHardness(1F); setTranslationKey(identifier);
    }
    @Override protected BlockEntity createBlockEntity() { return new WorldlinePairBlockEntity(); }
