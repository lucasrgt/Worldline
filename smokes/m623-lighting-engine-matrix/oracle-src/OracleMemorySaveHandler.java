...
/** Official-name in-memory save boundary for the lighting fixture. */
@SuppressWarnings("rawtypes")
final class OracleMemorySaveHandler implements om, fl {
  private final ct info;
  private final OracleMemoryChunkLoader chunks = new OracleMemoryChunkLoader();

  OracleMemorySaveHandler(long seed, String name) {
