...
public final class KnockbackCooldownSetSmoke{
 ...
 public static void main(String[]a)throws Exception{
  ...
  BlockPosition top,spawner;int column;PlayerPose pose,before;RemoteIncomingHit hit;RemoteMobSpawn zombie;B173EntityVelocity knockback;double mobX,mobZ;
