...
- Easy difficulty deals 2 damage (`20 -> 18`). Packet38 status `2` precedes
  Packet8. Knockback is the Packet13 pose delta away from the Packet31 mob
...
```text
v1|server=official-b1.7.3|seed=17320110707|fixture=raised-7x7-grass-platform+zombie-spawner52|cause=nbt-entityid-zombie+time-14000+melee-contact|wire=packet24-type54+packet38-status2+packet8-health20->18+packet13-pose-away|oracle=zombie-melee-knockback+hurt-time-cooldown-not-env-not-pvp-not-sword|column=17,support=4:71:4:1:0,spawner=4:72:4:52:0,mob=type54,health=20->18,damage=2,knockback=away,cooldown=held,hurt=packet38-status2,night=14000,persisted=true,clients=2,disconnect=clean
```
