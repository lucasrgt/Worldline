...
/** Keeps the lightning fixture entirely in memory. */
@SuppressWarnings("rawtypes")
final class LightningMemorySaveHandler implements ISaveHandler, IPlayerFileData {
  private final WorldInfo info;
  private final LightningMemoryChunkLoader chunks = new LightningMemoryChunkLoader();
  LightningMemorySaveHandler(long seed, String name) {
