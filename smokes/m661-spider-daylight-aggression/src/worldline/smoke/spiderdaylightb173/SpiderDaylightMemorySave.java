...
/** Minimal in-memory open-sky world for the spider daylight fixture. */
@SuppressWarnings("rawtypes")
final class SpiderDaylightMemorySave implements ISaveHandler, IPlayerFileData {
    private final WorldInfo info;
    private final Chunks chunks = new Chunks();

    SpiderDaylightMemorySave(long seed, String name) {
