...
/** Official-name in-memory open-sky world for the spider daylight oracle. */
@SuppressWarnings("rawtypes")
final class OracleSpiderDaylightMemorySave implements om, fl {
    private final ct info;
    private final Chunks chunks = new Chunks();

    OracleSpiderDaylightMemorySave(long seed, String name) {
