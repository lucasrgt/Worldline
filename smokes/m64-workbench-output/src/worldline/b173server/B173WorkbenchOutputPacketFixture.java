...
public final class B173WorkbenchOutputPacketFixture {
    ...
    public static void verify() throws Exception {
        ...
        require(in.readUnsignedByte() == 102 && in.readUnsignedByte() == 7 && in.readShort() == 37
                && in.readUnsignedByte() == 0 && in.readShort() == 6 && !in.readBoolean() && in.readShort() == -1);
        require(in.available() == 0 && bytes.size() == 23);
    }
    private static void require(boolean value) { if (!value) throw new AssertionError("workbench output wire drifted"); }
}
