...
public final class M3DomainApiOracle {
  ...
  public static void main(String[] arguments) {
    ...
    client.z.y = 0;
    client.I =
        OracleClientBoundaries.allocateWithoutConstructor(OracleClientBoundaries.Statistics.class);
    ...
    record
    (trace, "loaded", world, player);
    require(world.b(8, 65, 8, 20, 3), "oracle block mutation failed");
    player.e(10.5D, 66.0D, 10.5D);
    player.c.c = 4;
    record
    (trace, "mutated", world, player);
    for (int tick = 1; tick <= 3; tick++) {
      setTicks(client, ticks(client) + 1);
      client.k();
    }
    record
    (trace, "tick3", world, player);
    require(world.t() == 3L && player.c.c == 4 && !Display.isCreated(),
        "oracle final invariant failed");
    client.J = false;
  ...
  private static void record(CanonicalStateTrace trace, String label, fd world, dc player) {
    trace.record(label, world.t(), world.a(8, 64, 8), world.e(8, 64, 8), world.a(8, 65, 8),
        world.e(8, 65, 8), world.b.size() + 1L, player.aD, player.be ? 0 : 1,
        Double.doubleToLongBits(player.aM), Double.doubleToLongBits(player.aN),
        Double.doubleToLongBits(player.aO), player.Y, player.c.c);
  }

  private static int ticks(net.minecraft.client.Minecraft client) {
    return field(client).getInt(client);
  }
  private static void setTicks(net.minecraft.client.Minecraft client, int value) {
    field(client).setInt(client, value);
  }
  private static IntField field(net.minecraft.client.Minecraft client) {
    return new IntField(client, "V");
  }
  ...
  private static final class IntField {
    ...
    void setInt(Object ignored, int value) {
      try {
