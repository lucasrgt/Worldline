...
final class LavaWorldBackend implements GameBackend {
    ...
    LavaWorldBackend(long seed, int fixture) { this.seed = seed; this.fixture = fixture; }
    ...
    @Override public void loadWorld(WorldSource source) {
        ...
        require(world.setBlockAndMetadataWithNotify(X, SOURCE_Y, Z,
                Block.lavaMoving.blockID, 0), "lava source placement failed");
    }
    ...
    void assertOutcome() {
        ...
        } else require(lava(id(64)) && lava(id(61)),
