...
public final class WorldlineLavaDownwardFlowOracle {
    ...
    private static void run(CanonicalTrace trace, String label, int fixture) {
        ...
        if (fixture == OracleLavaMemoryChunkLoader.BLOCKED) {
            ...
            require(lava(world.a(X, 67, Z)) && lava(world.a(X, 65, Z))
                    && world.a(X, 64, Z) == na.u.bn, "open column did not flow to its floor");
        } else require(lava(world.a(X, 64, Z)) && lava(world.a(X, 61, Z)),
    ...
    private static boolean lava(int id) { return id == na.D.bn || id == na.E.bn; }
