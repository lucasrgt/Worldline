/** Official-name isolated vertical lava column in three floor variants. */
final class OracleLavaMemoryChunkLoader implements an {
  static final int OPEN = 0;
  static final int BLOCKED = 1;
  static final int SHAFT = 2;
  private static final int HEIGHT = 128;
  private final int fixture;
  OracleLavaMemoryChunkLoader(int fixture) {
