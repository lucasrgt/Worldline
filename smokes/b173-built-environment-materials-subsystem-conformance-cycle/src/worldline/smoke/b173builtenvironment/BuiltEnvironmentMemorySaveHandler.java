...
/** Removes filesystem persistence while retaining vanilla World behavior. */
@SuppressWarnings("rawtypes")
final class BuiltEnvironmentMemorySaveHandler implements ISaveHandler, IPlayerFileData {
  private final WorldInfo info;
  private final BuiltEnvironmentMemoryChunkLoader chunks = new BuiltEnvironmentMemoryChunkLoader();

  BuiltEnvironmentMemorySaveHandler(long seed, String name) {
