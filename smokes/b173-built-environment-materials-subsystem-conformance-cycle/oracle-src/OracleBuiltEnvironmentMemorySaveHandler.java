...
final class OracleBuiltEnvironmentMemorySaveHandler implements om, fl {
  private final ct info;
  private final OracleBuiltEnvironmentMemoryChunkLoader chunks =
      new OracleBuiltEnvironmentMemoryChunkLoader();

  OracleBuiltEnvironmentMemorySaveHandler(long seed, String name) {
