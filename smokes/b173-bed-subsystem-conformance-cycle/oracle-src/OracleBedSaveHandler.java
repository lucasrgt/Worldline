...
final class OracleBedSaveHandler implements om, fl {
    private final ct info;
    private final OracleBedChunkLoader chunks = new OracleBedChunkLoader();

    OracleBedSaveHandler(long seed, String name) {
