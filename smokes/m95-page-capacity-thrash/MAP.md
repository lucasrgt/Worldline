...
- `directFallbacks=0` and exactly two page rebuilds;
- a positive cumulative eviction count that advances by exactly two from
...
pinned replacement policy, two pages survive into the next frame and two are
