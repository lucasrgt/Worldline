...
final class FurnaceMemorySaveHandler implements ISaveHandler, IPlayerFileData {
    private final WorldInfo info;
    private final FurnaceMemoryChunkLoader chunks = new FurnaceMemoryChunkLoader();

    FurnaceMemorySaveHandler(long seed, String name) {
