...
final class OracleFurnaceSaveHandler implements om, fl {
    private final ct info;
    private final OracleFurnaceChunkLoader chunks = new OracleFurnaceChunkLoader();

    OracleFurnaceSaveHandler(long seed, String name) {
