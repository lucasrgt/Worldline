  ...
  public static void main(String[] arguments) throws Exception {
    ...
    try {
      ...
      B173PlayerSeed.writeInventory(workspace, user, 4.5D, 60D, 4.5D,
          new int[] {0, 1, 2, 3, 4, 5, 6, 7}, new int[] {1, 61, 12, 4, 349, 263, 263, 263},
      ...
      FurnaceRestSmeltsSupport.require(inventory.occupiedSlots() == 8
              && inventory.slot(38).item().equals(sand) && inventory.slot(39).item().equals(cobble)
              && inventory.slot(40).item().equals(fish) && inventory.slot(41).item().equals(coal)
      ...
      FurnaceRestSmeltsSupport.Raised raised = FurnaceRestSmeltsSupport.raise(
      ...
      RemoteFurnaceSmelt sandSmelt =
          FurnaceRestSmeltsClicks.smelt(actor, sandFurnace, 38, 41, sand, glass);
      RemoteFurnaceSmelt cobbleSmelt =
          FurnaceRestSmeltsClicks.smelt(actor, cobbleFurnace, 39, 42, cobble, stone);
      RemoteFurnaceSmelt fishSmelt =
          FurnaceRestSmeltsClicks.smelt(actor, fishFurnace, 40, 43, fish, cooked);
      FurnaceRestSmeltsSupport.require(sandSmelt.output().equals(glass)
              && cobbleSmelt.output().equals(stone) && fishSmelt.output().equals(cooked),
          "compound rest furnace outputs drifted");
      actor.close();
