...
public final class AeroAttributionSmoke {
  ...
  public static void main(String[] arguments) throws Exception {
    ...
    if ("diagnose".equals(arguments[0]))
      diagnose();
    else if ("artifact".equals(arguments[0]))
      artifact();
    else
  ...
  private static void diagnose() throws Exception {
    ...
    FrameAttribution.Result logical =
        AeroFrameLog.compare(baseline, line("80.0", "0", 720, 720, 90));
    FrameAttribution.Result runtime = AeroFrameLog.compare(baseline, line("80.0", "36", 12, 12, 3));
  ...
  private static String line(
      String frameMs, String gcMs, long accepted, long flushed, long batches) {
