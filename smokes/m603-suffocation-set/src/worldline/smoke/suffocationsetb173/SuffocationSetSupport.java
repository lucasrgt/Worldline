...
final class SuffocationSetSupport {
  ...
  static PlayerPose walk(B173WireClient actor, PlayerPose here, double x, double y, double z) throws Exception {
    int step = 0;
    while (step < 32) {
      double dx = x - here.x();
      double dy = y - here.y();
    ...
    throw new IllegalStateException("suffocation walk failed x=" + here.x() + " y=" + here.y() + " z=" + here.z());
  }
