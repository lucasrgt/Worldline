...
public final class HotbarEmptySelectionSmoke {
    ...
    public static void main(String[] args) throws Exception {
        if (args.length != 6) throw new IllegalArgumentException("invalid M521 arguments");
        ...
        require(seed == 17320110707L && actorName.equals("Hotbar521A")
                && observerName.equals("Hotbar521B"), "M521 identity drift");
        Duration timeout = Duration.ofSeconds(90);
        B173DedicatedServer server = new B173DedicatedServer(jar, workspace, port,
                seed, timeout, 3, true);
        ...
        try {
            ...
            B173PlayerSeed.writeInventory(workspace, actorName, 4.5D, 60D, 4.5D,
                    new int[] {0}, new int[] {1}, new int[] {1}, new int[] {0});
            ...
            require(inventory.occupiedSlots() == 1
                    ...
                    && inventory.slot(37).empty(), "hotbar seed drift");
