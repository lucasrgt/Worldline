...
public final class BasicCraftsSmoke {
  ...
  public static void main(String[] arguments) throws Exception {
    ...
    require(B173BasicCraftsClick.STICKS.legacyId() == 280
            && B173BasicCraftsClick.TORCHES.legacyId() == 50
            && B173BasicCraftsClick.PLANKS4.legacyId() == 5
            && B173BasicCraftsClick.COAL.legacyId() == 263,
    ...
    try {
      server.boot();
      B173PlayerSeed.writeInventory(workspace, user, 4.5D, 72D, 4.5D, new int[] {0, 1},
          new int[] {17, 263}, new int[] {1, 1}, new int[] {0, 0});
      actor.connect();
      actor.synchronizePose();
      RemoteInventoryView initial = actor.awaitInventory();
      require(initial.occupiedSlots() == 2
              && initial.slot(36).item().equals(B173BasicCraftsClick.LOG)
              && initial.slot(37).item().equals(B173BasicCraftsClick.COAL)
              && B173BasicCraftsClick.emptyCraft(initial),
          "log/coal seed drifted");
      B173BasicCraftsClick.planks(actor);
      require(actor.inventory().slot(36).item().equals(B173BasicCraftsClick.PLANKS4)
              && B173BasicCraftsClick.emptyCraft(actor.inventory()),
          "crafted planks 5x4 drifted");
  ...
  private static void requireStored(RemoteInventoryView view) {
    require(!view.slot(36).empty() && view.slot(36).item().equals(B173BasicCraftsClick.PLANKS2)
            ...
            && view.slot(37).item().legacyId() == 50 && !view.slot(38).empty()
            && view.slot(38).item().equals(B173BasicCraftsClick.STICKS3)
            && view.slot(38).item().legacyId() == 280 && B173BasicCraftsClick.emptyCraft(view)
            && view.occupiedSlots() == 3,
