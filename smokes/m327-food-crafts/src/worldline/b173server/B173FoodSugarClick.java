...
public final class B173FoodSugarClick {
    ...
    public static void apply(B173WireClient actor) {
        try {
            ...
            step(channel, inbound, 2, 1, 1, null, replace(replace(inbound.inventory(), 1, CANE1), 0, SUGAR), CANE1);
            ...
            step(channel, inbound, 4, 0, 0, SUGAR, replace(replace(inbound.inventory(), 0, null), 1, null), SUGAR);
            ...
            step(channel, inbound, 7, 1, 0, null, replace(replace(inbound.inventory(), 1, CANE1), 0, SUGAR), null);
            step(channel, inbound, 8, 0, 0, SUGAR, replace(replace(inbound.inventory(), 0, null), 1, null), SUGAR);
