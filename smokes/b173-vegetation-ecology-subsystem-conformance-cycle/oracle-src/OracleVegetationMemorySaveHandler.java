...
final class OracleVegetationMemorySaveHandler implements om, fl {
  private final ct info;
  private final OracleVegetationMemoryChunkLoader chunks =
      new OracleVegetationMemoryChunkLoader();

  OracleVegetationMemorySaveHandler(long seed, String name) {
