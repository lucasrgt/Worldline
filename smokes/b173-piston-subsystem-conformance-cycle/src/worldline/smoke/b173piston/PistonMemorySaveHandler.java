...
final class PistonMemorySaveHandler implements ISaveHandler, IPlayerFileData {
    private final WorldInfo info;
    private final PistonMemoryChunkLoader chunks = new PistonMemoryChunkLoader();

    PistonMemorySaveHandler(long seed, String name) {
