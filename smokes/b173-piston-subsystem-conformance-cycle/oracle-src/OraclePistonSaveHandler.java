...
final class OraclePistonSaveHandler implements om, fl {
    private final ct info;
    private final OraclePistonChunkLoader chunks = new OraclePistonChunkLoader();

    OraclePistonSaveHandler(long seed, String name) {
