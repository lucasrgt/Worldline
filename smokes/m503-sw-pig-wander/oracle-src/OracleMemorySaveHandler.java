...
/** Official-name in-memory save boundary for the pig fixture. */
...
final class OracleMemorySaveHandler implements om, fl {
  ...
  OracleMemorySaveHandler(long seed, String name, boolean caged) {
    info = new ct(seed, name);
    info.a(8, 64, 8);
    chunks = new OracleMemoryChunkLoader(caged);
  }
