...
final class FarmlandMemorySaveHandler implements ISaveHandler, IPlayerFileData {
    private final WorldInfo info;
    private final FarmlandMemoryChunkLoader chunks = new FarmlandMemoryChunkLoader();

    FarmlandMemorySaveHandler(long seed, String name) {
