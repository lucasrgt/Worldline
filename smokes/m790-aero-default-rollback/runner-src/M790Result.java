...
record M790Result(boolean visualPass, boolean workloadRepeatable, boolean capturePass,
                  ...
                  int allocationWins, M790Hitch hitch, boolean performancePass) {
    boolean integrityPass() { return visualPass && workloadRepeatable && capturePass; }

    String decision() {
        if (performancePass) return "default-confirmed";
