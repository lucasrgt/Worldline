...
final class QueueReusePageMetrics {
    ...
    static void beginArm() {
        ...
        queueAllocatedStart = WorldlineM790QueueReuse.allocatedPages();
        queueReusedStart = WorldlineM790QueueReuse.reusedPages();
        queueDiscardedStart = WorldlineM790QueueReuse.discardedPages();
    }
    ...
    static void write(PrintWriter out) {
        ...
        out.println("queue.reuse.enabled=" + WorldlineM790QueueReuse.enabled());
        out.println("queue.pool.pages=" + WorldlineM790QueueReuse.pooledPages());
        out.println("queue.allocated="
            + (WorldlineM790QueueReuse.allocatedPages() - queueAllocatedStart));
        out.println("queue.reused=" + (WorldlineM790QueueReuse.reusedPages() - queueReusedStart));
        out.println("queue.discarded="
            + (WorldlineM790QueueReuse.discardedPages() - queueDiscardedStart));
