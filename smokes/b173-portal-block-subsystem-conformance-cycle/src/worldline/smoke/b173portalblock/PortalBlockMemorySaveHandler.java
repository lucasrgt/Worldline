...
final class PortalBlockMemorySaveHandler implements ISaveHandler, IPlayerFileData {
    private final WorldInfo info;
    private final PortalBlockMemoryChunkLoader chunks = new PortalBlockMemoryChunkLoader();

    PortalBlockMemorySaveHandler(long seed, String name) {
