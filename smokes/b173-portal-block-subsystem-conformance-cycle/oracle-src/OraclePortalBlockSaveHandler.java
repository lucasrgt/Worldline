...
final class OraclePortalBlockSaveHandler implements om, fl {
    private final ct info;
    private final OraclePortalBlockChunkLoader chunks = new OraclePortalBlockChunkLoader();

    OraclePortalBlockSaveHandler(long seed, String name) {
