...
final class RedstoneTorchMemorySaveHandler implements ISaveHandler, IPlayerFileData {
    private final WorldInfo info;
    private final RedstoneTorchMemoryChunkLoader chunks = new RedstoneTorchMemoryChunkLoader();

    RedstoneTorchMemorySaveHandler(long seed, String name) {
