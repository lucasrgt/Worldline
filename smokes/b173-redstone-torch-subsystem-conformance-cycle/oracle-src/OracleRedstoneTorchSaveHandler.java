...
final class OracleRedstoneTorchSaveHandler implements om, fl {
    private final ct info;
    private final OracleRedstoneTorchChunkLoader chunks = new OracleRedstoneTorchChunkLoader();

    OracleRedstoneTorchSaveHandler(long seed, String name) {
