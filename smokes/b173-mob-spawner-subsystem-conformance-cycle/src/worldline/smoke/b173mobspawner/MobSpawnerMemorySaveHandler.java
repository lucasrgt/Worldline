...
final class MobSpawnerMemorySaveHandler implements ISaveHandler, IPlayerFileData {
    private final WorldInfo info;
    private final MobSpawnerMemoryChunkLoader chunks = new MobSpawnerMemoryChunkLoader();

    MobSpawnerMemorySaveHandler(long seed, String name) {
