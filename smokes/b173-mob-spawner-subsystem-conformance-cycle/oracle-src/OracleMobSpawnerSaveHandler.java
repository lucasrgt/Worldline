...
final class OracleMobSpawnerSaveHandler implements om, fl {
    private final ct info;
    private final OracleMobSpawnerChunkLoader chunks = new OracleMobSpawnerChunkLoader();

    OracleMobSpawnerSaveHandler(long seed, String name) {
