...
final class OracleRedstoneOreSaveHandler implements om, fl {
    private final ct info;
    private final OracleRedstoneOreChunkLoader chunks = new OracleRedstoneOreChunkLoader();

    OracleRedstoneOreSaveHandler(long seed, String name) {
