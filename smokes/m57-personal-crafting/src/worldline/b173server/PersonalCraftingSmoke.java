    ...
    public static void main(String[] arguments) throws Exception {
        ...
        try {
            ...
            require(craft.takeAction() == 1 && craft.placeAction() == 2 && craft.resultAction() == 3
                    ...
                    && craft.output().equals(planks), "craft transaction identity drifted");
            require(craft.matrix().slot(36).empty() && craft.matrix().slot(1).item().equals(log)
                    && craft.matrix().slot(0).item().equals(planks), "craft matrix transition drifted");
        ...
        System.out.println("WORLDLINE_M57_CRAFT=actions=" + craft.takeAction() + "," + craft.placeAction()
                + "," + craft.resultAction() + "," + craft.storeAction() + "," + audit.actionId() + ","
                + restored.actionId() + ";ingredient=" + craft.ingredient() + ";output=" + craft.output()
