...
public final class GoldenAppleEatSmoke{
 ...
 public static void main(String[]a)throws Exception{
  if(a.length!=7)throw new IllegalArgumentException("usage: GoldenAppleEatSmoke server.jar workspace port seed username chunkX chunkZ");
  ...
  try{
   server.boot();B173PlayerSeed.writeInventory(workspace,user,4.5D,60D,4.5D,new int[]{0},new int[]{322},new int[]{1},new int[]{0},10);
   ...
   System.out.println("WORLDLINE_M261_GOLDEN="+evidence);System.out.println("WORLDLINE_M261_TRACE="+trace);System.out.println("WORLDLINE_M261_SIGNATURE="+sha(trace));
