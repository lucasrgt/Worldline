...
public final class B173DyeMixCraft {
    ...
    private static final int[] LEFT_DMG = {1, 1, 2}, RIGHT_DMG = {11, 4, 15}, RESULT_DMG = {14, 5, 10};
    ...
    private static final int[] CLICK_DAMAGE = {1, 0, 11, 0, 14, 0, 1, 0, 4, 0, 5, 0, 2, 0, 15, 0, 10, 0};
    ...
    public static void apply(B173WireClient actor) {
        try {
            ...
            if (action != 19 || inbound.cursor() != null) throw new IllegalStateException("dye-mix action drift");
