...
public final class WorldlineContentRenderer extends BlockEntityRenderer {
  ...
  public void render(BlockEntity raw, double x, double y, double z, float partialTick) {
    ...
    Aero_BECellRenderer.queueAtRest(
        MODEL, "/terrain.png", entity, x, y, z, 0F, brightness, Aero_RenderOptions.DEFAULT);
    WorldlineContentProbe.rendered(
        entity.x, entity.y, entity.z, WorldlineContentMod.block.id, entity.nonce());
  }
}
