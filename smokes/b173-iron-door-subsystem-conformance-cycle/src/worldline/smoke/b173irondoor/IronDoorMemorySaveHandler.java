...
final class IronDoorMemorySaveHandler implements ISaveHandler, IPlayerFileData {
    private final WorldInfo info;
    private final IronDoorMemoryChunkLoader chunks = new IronDoorMemoryChunkLoader();

    IronDoorMemorySaveHandler(long seed, String name) {
