...
public final class WheatLightHaltSetSmoke {
 ...
 public static void main(String[] a) throws Exception {
  ...
  WheatLightHaltSetArm.require(seed == 17320110707L && user.equals("WheatHalt577")
  ...
  try {
   ...
   WheatLightHaltSetArm.require(actor.awaitInventory().occupiedSlots() == 5,
     "wheat-light-halt inventory drift");
   ...
   WheatLightHaltSetArm.require(WheatLightHaltSetArm.crops(planted, lit, wheatS, cover),
     "pad cells missing before random-tick wait "
       + WheatLightHaltSetArm.dump(planted, lit, wheatS, cover));
   ...
   String evidence = "column=" + column[0] + ",support=" + WheatLightHaltSetArm.token(top, 1, 0)
     + ",water=" + WheatLightHaltSetArm.token(water, 9, 0)
     + ",hoe=290,seeds=295,wheat=59,lit=" + WheatLightHaltSetArm.cells(lit)
     + ",covered=" + WheatLightHaltSetArm.token(wheatS, 59, 0)
