...
public final class RemoteWorldCacheSmoke {
    ...
    public static void main(String[] arguments) throws Exception {
        ...
        CachedRemoteWorldMultiplayerSession client = new B173WireClient(
                "127.0.0.1", port, arguments[4], timeout);
        RemoteWorldView view;
        try {
            server.boot(); client.connect(); client.synchronizePose();
            view = client.awaitRemoteWorld(1); verify(view);
        ...
        System.out.println("WORLDLINE_M30_WORLD=chunks=" + view.loadedChunks() + ",first="
                + first.x() + ":" + first.z() + ",last=" + last.x() + ":" + last.z());
