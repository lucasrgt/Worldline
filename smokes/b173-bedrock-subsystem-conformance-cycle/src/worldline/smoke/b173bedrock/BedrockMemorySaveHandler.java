...
final class BedrockMemorySaveHandler implements ISaveHandler, IPlayerFileData {
    private final WorldInfo info;
    private final BedrockMemoryChunkLoader chunks = new BedrockMemoryChunkLoader();

    BedrockMemorySaveHandler(long seed, String name) {
