...
public final class AcceptedPersonalTransactionSmoke {
  ...
  public static void main(String[] arguments) throws Exception {
    ...
    RemotePersonalTransaction take, place;
    ...
    try {
      ...
      require(place.actionId() == 2 && place.slot() == 36 && place.predictedEmpty()
              ...
              && place.after().slot(36).item().equals(stone)
              && actor.inventory().equals(place.after()),
    ...
    System.out.println(
        "WORLDLINE_M55_API=personal-left-click,packet102,packet106,optimistic-commit");
  ...
  private static PersonalInventoryTransactionSession client(
      int port, String name, Duration timeout) {
  ...
  private static void acquire(PersonalInventoryTransactionSession client, String username) {
    ...
    }, inventory -> inventory.occupiedSlots() >= 1, "personal grant", 15);
