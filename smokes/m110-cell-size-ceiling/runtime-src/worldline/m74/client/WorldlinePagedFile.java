...
public final class WorldlinePagedFile {
  ...
  public static void write() {
    if (!WorldlinePagedBridge.sealed() || written)
      throw new IllegalStateException("invalid M110 write state");
    ...
    try {
      ...
      try (DataOutputStream out = new DataOutputStream(new BufferedOutputStream(
        ...
        for (int i = 0; i < WorldlinePagedBridge.count(); i++) {
          ...
          out.writeInt(WorldlinePagedTimer.immediate[i]);
        }
      }
      ...
      throw new IllegalStateException("M110 artifact write failed", e);
    }
  }
}
