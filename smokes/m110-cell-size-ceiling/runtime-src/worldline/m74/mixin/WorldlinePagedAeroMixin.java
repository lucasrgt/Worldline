...
public abstract class WorldlinePagedAeroMixin {
    ...
    @Inject(method="drawDirect(Laero/modellib/model/Aero_MeshModel;Ljava/lang/String;DDDFFLaero/modellib/render/Aero_RenderOptions;)V",at=@At("HEAD"),remap=false)
    private static void direct(Aero_MeshModel m,String t,double x,double y,double z,float r,float b,Aero_RenderOptions o,CallbackInfo ci){WorldlinePagedTimer.immediateDirect();}
}
