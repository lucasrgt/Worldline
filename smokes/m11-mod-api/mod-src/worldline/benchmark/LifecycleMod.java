...
public final class LifecycleMod implements B173Mod {
    ...
    @Override public void onLoad(B173ModContext context) {
        ...
        context.at(3, () -> context.world().setBlock(
                new BlockPosition(9, 65, 9), new BlockState(20, 0)));
    }

    @Override public void onTick(B173ModContext context) { }

    @Override public void onDispose() { worldline.smoke.m11.DisposeMarker.mark(); }
}
