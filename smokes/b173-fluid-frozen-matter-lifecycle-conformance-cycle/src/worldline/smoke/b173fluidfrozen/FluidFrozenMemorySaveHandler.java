...
final class FluidFrozenMemorySaveHandler implements ISaveHandler, IPlayerFileData {
  private final WorldInfo info;
  private final FluidFrozenMemoryChunkLoader chunks = new FluidFrozenMemoryChunkLoader();

  FluidFrozenMemorySaveHandler(long seed, String name) {
