...
public final class B173RemainingWoolCraft {
    private static final int[] WOOL_SLOTS = {36, 37, 38}, DYE_SLOTS = {39, 40, 41}, RESULTS = {2, 3, 5};
    ...
    private static final int[] CLICK_DAMAGE = {0, 0, 13, 0, 2, 0, 0, 0, 12, 0, 3, 0, 0, 0, 10, 0, 5, 0};
    ...
    public static void apply(B173WireClient actor) {
        try {
            ...
            if (action != 19 || inbound.cursor() != null) throw new IllegalStateException("remaining dyed-wool action drift");
