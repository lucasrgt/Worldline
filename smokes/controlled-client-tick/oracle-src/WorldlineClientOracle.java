...
public final class WorldlineClientOracle {
  ...
  public static void main(String[] arguments) {
    ...
    fd world = new fd(
        new OracleClientWorld(SEED, "worldline-client-cycle"), "worldline-client-cycle", SEED);
    ...
    require(ticksRan(client) == 16 && world.t() == 16L, "official tick(N) did not advance to 16");
    client.J = false;
    ...
    System.out.println("WORLDLINE_PHYSICS_TRACE=v2|"
        + OfficialPhysicsProbe.trace(world, player).substring(3)
        + "|compass=" + OfficialCompassProbe.trace(client, world, player));
  }

  private static CanonicalStateTrace stateTrace() {
    return new CanonicalStateTrace(SEED, "clientTick", "worldTime", "rngSeed", "entities",
        "cloudTick", "guiTick", "rendererTick", "playerX", "playerY", "playerZ", "health", "slot",
        "block64", "block65");
  }
  ...
  private static void state(
    ...
    trace.record(label, ticksRan(client), client.f.t(), RNG_SEED, client.f.b.size(),
        ...
        Double.doubleToLongBits(client.h.aN), Double.doubleToLongBits(client.h.aO), client.h.Y,
        client.h.c.c, client.f.a(X, 64, Z), client.f.a(X, 65, Z));
  }
  ...
  private static void snapshot(
      CanonicalTrace trace, String label, net.minecraft.client.Minecraft client) {
    trace.record(label, client.f.t(), client.f.b.size(), ticksRan(client), client.f.a(X, 64, Z),
        client.f.a(X, 65, Z));
  }
