...
public final class SpawnLightCapSetSmoke {
  ...
  public static void main(String[] args) throws Exception {
    ...
    SpawnLightCapPad.require(
        seed == 17320110707L && user.equals("SpawnLit617") && user.length() <= 16, "spawn-light-cap identity drift");
    ...
    try {
      ...
      SpawnLightCapPad.require(actor.awaitInventory().occupiedSlots() >= 1, "spawn-light-cap dark inventory drift");
      ...
      SpawnLightCapPad.require((spawned.legacyType() == 50 || spawned.legacyType() == 54) && spawned.legacyType() != 90
              && spawned.legacyType() != 51 && spawned.legacyType() != 52,
    ...
    try {
      ...
      actor.connect();
      actor.synchronizePose();
      SpawnLightCapPad.require(actor.awaitInventory().occupiedSlots() >= 1, "spawn-light-cap torch inventory drift");
      ...
      String evidence = "column=" + pad.column
          + ",platform=7x7-48grass,spawners=" + SpawnLightCapPad.cell(pad.first, 52, 0) + "+"
          + SpawnLightCapPad.cell(pad.second, 52, 0) + ",entityid=Creeper+Zombie,dark=type50-or-54,torch=50:5x"
          + torches + ",dark-light=0,lit-light>=8,torch-arm=absent,night=14000,clients=4,disconnect=clean";
      String trace = "v1|server=official-b1.7.3|seed=" + seed + "|fixture=raised-7x7-grass-platform+two-spawner52"
          ...
          + "-not-m435-natural-not-m569-delay-not-m564-carpet|" + evidence;
