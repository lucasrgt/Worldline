...
public final class TorchBurnoutSetSmoke {
    ...
    public static void main(String[] args) throws Exception {
        if (args.length != 7)
            throw new IllegalArgumentException("usage: TorchBurnoutSetSmoke server.jar workspace port seed username chunkX chunkZ");
        ...
        try {
            ...
            TorchBurnoutSetSupport.require(actor.awaitInventory().occupiedSlots() == 7, "torch burnout inventory drift");
            ...
            BlockState on = new BlockState(76, 4), off = new BlockState(75, 4), floor = new BlockState(76, 5);
            ...
            TorchBurnoutSetSupport.require(after.blockAt(TorchBurnoutSetSupport.local(top.x(), cx), top.y(),
                    TorchBurnoutSetSupport.local(top.z(), cz)).equals(new BlockState(1, 0))
                    && placed.equals(on) && placed.legacyId() == 76 && placed.metadata() == 4 && !placed.equals(off)
