...
100-tick window. Final serialized qualification is pending.

Expected trace shape:

```text
v1|server=official-b1.7.3|seed=17320110707|fixture=raised-stone+inverter+torch76-burnout|cause=packet15-item76-then-rapid-lever-toggles|wire=packet53-torch76:4<->torch75:4|oracle=live-on+burnout-off-unpowered+recover-on+fresh-login|column=<runtime>,support=<runtime>:1:0,torch=<runtime>:76:4->75:4->76:4,burnout=75:4,recovered=76:4,rapidActivations=24,recoveryWait=400,persisted=76:4,clients=2,disconnect=clean
```
