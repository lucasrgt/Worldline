...
public final class StickyHeadBreakSetArm {
    ...
    private StickyHeadBreakSetArm(BlockPosition support, BlockPosition piston, BlockPosition head,
    ...
    static StickyHeadBreakSetArm place(B173WireClient actor, RemoteChunkSnapshot initial,
        ...
        require(at(initial, piston, chunkX, chunkZ).legacyId() == 0
                && at(initial, head, chunkX, chunkZ).legacyId() == 0
    ...
    RemoteWorldView extend(B173WireClient actor, int ticks) throws Exception {
        ...
        RemoteWorldView live = WorldlineSmokeAwait.awaitWorld(actor, view ->
