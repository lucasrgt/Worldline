...
public final class M5BundleSmoke {
    ...
    public static void main(String[] arguments) throws Exception {
        ...
        if (arguments[0].equals("pack")) bundle = B173ReplayProvider.bundle(snapshot);
        else if (arguments[0].equals("wrong-runtime")) bundle = create(snapshot,
                "minecraft-b1.7.4-client", B173ReplayProvider.WORLDLINE_VERSION,
                B173ReplayProvider.CLIENT_SHA256, B173ReplayProvider.TOOLCHAIN_REVISION);
        else if (arguments[0].equals("wrong-worldline")) bundle = create(snapshot,
                B173ReplayProvider.RUNTIME_ID, "9.9.9", B173ReplayProvider.CLIENT_SHA256,
                B173ReplayProvider.TOOLCHAIN_REVISION);
        else if (arguments[0].equals("wrong-client")) bundle = create(snapshot,
                B173ReplayProvider.RUNTIME_ID, B173ReplayProvider.WORLDLINE_VERSION,
                repeat('0', 64), B173ReplayProvider.TOOLCHAIN_REVISION);
        else if (arguments[0].equals("wrong-toolchain")) bundle = create(snapshot,
                B173ReplayProvider.RUNTIME_ID, B173ReplayProvider.WORLDLINE_VERSION,
                B173ReplayProvider.CLIENT_SHA256, repeat('0', 40));
        else throw new IllegalArgumentException("unknown pack mode " + arguments[0]);
    ...
    private static ReproductionBundle create(RuntimeSnapshot snapshot, String runtime, String version,
            String client, String toolchain) {
