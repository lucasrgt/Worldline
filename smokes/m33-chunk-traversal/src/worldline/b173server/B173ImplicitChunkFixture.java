...
public final class B173ImplicitChunkFixture {
  ...
  public static void main(String[] arguments) throws Exception {
    ...
    try {
      cache.accept(chunk(2, -3));
      throw new AssertionError("strict cache accepted implicit load");
    } catch (IOException expected) {
    }
    cache.enableImplicitLoads();
    require(cache.accept(chunk(2, -3)), "implicit edge load rejected");
