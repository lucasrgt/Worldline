...
final class RedstoneSignalMemorySaveHandler implements ISaveHandler, IPlayerFileData {
  private final WorldInfo info;
  private final RedstoneSignalMemoryChunkLoader chunks = new RedstoneSignalMemoryChunkLoader();

  RedstoneSignalMemorySaveHandler(long seed, String name) {
