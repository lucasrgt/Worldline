...
final class OracleRedstoneSignalMemorySaveHandler implements om, fl {
  private final ct info;
  private final OracleRedstoneSignalMemoryChunkLoader chunks =
      new OracleRedstoneSignalMemoryChunkLoader();

  OracleRedstoneSignalMemorySaveHandler(long seed, String name) {
