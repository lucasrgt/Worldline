...
final class OracleLockedChestSaveHandler implements om, fl {
    private final ct info;
    private final OracleLockedChestChunkLoader chunks = new OracleLockedChestChunkLoader();

    OracleLockedChestSaveHandler(long seed, String name) {
