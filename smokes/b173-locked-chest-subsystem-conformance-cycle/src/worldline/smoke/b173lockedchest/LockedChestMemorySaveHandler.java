...
final class LockedChestMemorySaveHandler implements ISaveHandler, IPlayerFileData {
    private final WorldInfo info;
    private final LockedChestMemoryChunkLoader chunks = new LockedChestMemoryChunkLoader();

    LockedChestMemorySaveHandler(long seed, String name) {
