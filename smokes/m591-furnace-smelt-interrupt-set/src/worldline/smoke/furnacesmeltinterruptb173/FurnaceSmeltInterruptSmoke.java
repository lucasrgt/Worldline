...
public final class FurnaceSmeltInterruptSmoke {
    ...
    public static void main(String[] arguments) throws Exception {
        ...
        FurnaceSmeltInterruptSupport.require(seed == 17320110707L && user.equals("FurnInt591")
                && user.length() <= 16, "furnace-smelt-interrupt identity drift");
        ...
        try {
            ...
            B173PlayerSeed.writeInventory(workspace, user, 4.5D, 60D, 4.5D,
                    ...
                    new int[] {1, 61, 4, 4, 4, 263, 263, 263},
                    new int[] {32, 3, 1, 1, 1, 1, 1, 1},
                    new int[] {0, 0, 0, 0, 0, 0, 0, 0});
            actor.connect();
            actor.synchronizePose();
            RemoteInventoryView inventory = actor.awaitInventory();
            FurnaceSmeltInterruptSupport.require(inventory.occupiedSlots() == 8
            ...
            FurnaceSmeltInterruptSupport.Raised raised = FurnaceSmeltInterruptSupport.raise(actor,
            ...
            FurnaceSmeltInterruptSupport.require(control.output().equals(stone),
                    "control stone output drifted");
            actor.close();
            ...
            String evidence = "column=" + raised.column
                    ...
                    + FurnaceSmeltInterruptSupport.item(stone)
                    + ",input-out=empty,fuel-out=empty,clients=1,disconnect=clean";
            String trace = "v1|server=official-b1.7.3|seed=" + seed
                    + "|fixture=raised-stone+3xfurnace61:2+cobble4+coal263"
