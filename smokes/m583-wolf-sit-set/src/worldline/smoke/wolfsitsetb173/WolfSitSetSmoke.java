...
public final class WolfSitSetSmoke {
    ...
    public static void main(String[] arguments) throws Exception {
        ...
        require(seed == 17320110707L && user.equals("WolfSit583") && user.length() <= 16,
                "wolf-sit-set identity drift");
        ...
        try {
            ...
            B173PlayerSeed.writeInventory(workspace, user, 4.5D, 60D, 4.5D,
                    new int[] {0, 1, 2, 3, 4}, new int[] {1, 2, 52, 352, 280},
                    new int[] {32, 48, 1, 64, 1}, new int[] {0, 0, 0, 0, 0});
            actor.connect();
        ...
        try {
            ...
            require(actor.awaitInventory().occupiedSlots() >= 3,
                    "wolf-sit-set reload inventory drift");
            WorldlineSmokeAwait.observe(actor, 5);
            ...
            require((standing & 4) != 0 && (standing & 1) == 0,
                    "wolf Packet40 standing flag drift after unsit");
            ...
            require((stood & 4) != 0 && (stood & 1) == 0,
                    "wolf Packet40 standing flag drift after owner stand");
            require(B173ShearsAccess.peekDeath(actor, wolf.entityId()) == null,
                    "Packet38 status 3 death after sit-stand");
            actor.close();
            awaitPlayers(server, 0);
            server.save();
            String evidence = "column=" + column + ",platform=7x7-48grass,spawner="
                    + spawner.x() + ":" + spawner.y() + ":" + spawner.z()
                    + ":52:0,mob=type95,bone=352,tame=packet38-status7,"
            ...
            String trace = "v1|server=official-b1.7.3|seed=" + seed
                    ...
                    + "|oracle=tamed-wolf-type95-owner-sit-stand-not-m449-anger-not-m468-assist|"
                    + evidence;
