...
final class LeverButtonBackend implements GameBackend {
  ...
  void placeCircuit() {
    ...
    require(current.setBlockAndMetadataWithNotify(LEVER_X, Y, LEVER_Z, Block.lever.blockID, 13),
        "lever placement failed");
    ...
    require(current.setBlockAndMetadataWithNotify(BUTTON_X, Y, BUTTON_Z, Block.button.blockID, 9),
        "button placement failed");
