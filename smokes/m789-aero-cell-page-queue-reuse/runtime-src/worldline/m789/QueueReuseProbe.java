...
public final class QueueReuseProbe {
    ...
    private static void capture(Minecraft game, int checkpoint) {
        try {
            ...
            File directory = new File(System.getProperty("worldline.m789.framesDir"), arm);
            if (!directory.isDirectory() && !directory.mkdirs()) {
                throw new IllegalStateException("cannot create M789 frame directory");
            }
            ...
            throw new IllegalStateException("M789 framebuffer capture failed", error);
        }
    }
