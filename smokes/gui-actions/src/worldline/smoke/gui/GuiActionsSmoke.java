...
public final class GuiActionsSmoke {
    ...
    public static void main(String[] arguments) {
        ...
        try {
            ...
            ui.openInventory(); runtime.tick();
            GameUiContract.validate(ui);
            CanonicalStateTrace trace = trace(); record(trace, "opened", ui);
            ui.getSlot(36).dragTo(ui.getSlot(37)); runtime.tick();
            record(trace, "dragged", ui);
            ui.getSlot(37).rightClick(); runtime.tick();
            ui.getSlot(38).rightClick(); runtime.tick();
            record(trace, "split", ui);
    ...
    private static void record(CanonicalStateTrace trace, String label, GameUi ui) {
        ...
        trace.record(label, viewport.width(), viewport.height(), slot.x(), slot.y(), slot.width(), slot.height(),
                ui.slot(36).itemId(), ui.slot(36).count(), ui.slot(37).itemId(), ui.slot(37).count(),
                ui.slot(38).itemId(), ui.slot(38).count());
    }
