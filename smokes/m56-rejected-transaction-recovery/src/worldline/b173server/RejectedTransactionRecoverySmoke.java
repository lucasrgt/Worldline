...
public final class RejectedTransactionRecoverySmoke {
  ...
  public static void main(String[] arguments) throws Exception {
    ...
    RemoteRejectedTransaction rejected;
    RemotePersonalTransaction accepted;
    ...
    try {
      ...
      require(initial.occupiedSlots() == 1 && initial.slot(36).item().equals(stone),
          "recovery seed drifted");
      observer.connect();
      ...
      require(rejected.actionId() == 1 && rejected.slot() == 36 && rejected.stalePredictionEmpty()
              ...
              && actor.inventory().equals(rejected.authoritative()),
          "rejected recovery drifted");
    ...
    System.out.println("WORLDLINE_M56_RECOVERED=action=" + accepted.actionId() + ";slot="
        + accepted.after().slot(36).item() + ";cursor=empty;items=" + player.inventoryItems());
