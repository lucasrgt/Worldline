...
final class RedstoneInputsMemorySaveHandler implements ISaveHandler, IPlayerFileData {
  private final WorldInfo info;
  private final RedstoneInputsMemoryChunkLoader chunks = new RedstoneInputsMemoryChunkLoader();

  RedstoneInputsMemorySaveHandler(long seed, String name) {
