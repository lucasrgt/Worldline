...
final class OracleRedstoneInputsMemorySaveHandler implements om, fl {
  private final ct info;
  private final OracleRedstoneInputsMemoryChunkLoader chunks =
      new OracleRedstoneInputsMemoryChunkLoader();

  OracleRedstoneInputsMemorySaveHandler(long seed, String name) {
