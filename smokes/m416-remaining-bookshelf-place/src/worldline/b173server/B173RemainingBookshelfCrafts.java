...
public final class B173RemainingBookshelfCrafts {
  ...
  public static void apply(B173WireClient actor) {
    try {
      new B173RemainingBookshelfCrafts(actor).run();
    } catch (IOException error) {
      throw new IllegalStateException("remaining-bookshelf crafts failed", error);
    }
  }
  ...
  private void craft(int books, int planks) throws IOException {
    ...
    fill(planks, item(5, 6, 0), PLANKS,
        new RemoteItemStack[] {null, null, null, null, null, BOOKSHELF}, false);
