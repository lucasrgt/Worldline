...
final class OpenableAccessMemorySaveHandler implements ISaveHandler, IPlayerFileData {
  private final WorldInfo info;
  private final OpenableAccessMemoryChunkLoader chunks = new OpenableAccessMemoryChunkLoader();

  OpenableAccessMemorySaveHandler(long seed, String name) {
