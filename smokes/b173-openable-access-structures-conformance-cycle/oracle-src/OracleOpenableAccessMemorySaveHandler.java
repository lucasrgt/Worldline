...
final class OracleOpenableAccessMemorySaveHandler implements om, fl {
  private final ct info;
  private final OracleOpenableAccessMemoryChunkLoader chunks =
      new OracleOpenableAccessMemoryChunkLoader();

  OracleOpenableAccessMemorySaveHandler(long seed, String name) {
