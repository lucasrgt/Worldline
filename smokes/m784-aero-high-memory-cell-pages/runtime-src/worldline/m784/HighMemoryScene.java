...
final class HighMemoryScene {
    ...
    static void place(ClientPlayerEntity player, int frame) {
        ...
        if (local < 60) {
            ...
            x = 39.0D; y = 88.0D; z = 39.0D;
            tx = 34.0D; ty = 92.0D; tz = 34.0D;
        } else {
