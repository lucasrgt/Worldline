...
final class OracleRailNetworkMemorySaveHandler implements om, fl {
  private final ct info;
  private final OracleRailNetworkMemoryChunkLoader chunks =
      new OracleRailNetworkMemoryChunkLoader();

  OracleRailNetworkMemorySaveHandler(long seed, String name) {
