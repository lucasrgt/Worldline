...
final class RailNetworkMemorySaveHandler implements ISaveHandler, IPlayerFileData {
  private final WorldInfo info;
  private final RailNetworkMemoryChunkLoader chunks = new RailNetworkMemoryChunkLoader();

  RailNetworkMemorySaveHandler(long seed, String name) {
