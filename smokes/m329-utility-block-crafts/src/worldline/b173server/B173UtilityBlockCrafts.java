...
public final class B173UtilityBlockCrafts {
    ...
    public static void apply(B173WireClient actor) {
        try { new B173UtilityBlockCrafts(actor).run(); }
        catch (IOException error) { throw new IllegalStateException("utility-block crafts failed", error); }
    }
    ...
    private void run() throws IOException {
        ...
        craft(38, item(280, 6, 0), FENCES, new RemoteItemStack[] {null, null, null, null, null, FENCE}, FENCE);
        craft(39, item(280, 7, 0), LADDERS, new RemoteItemStack[] {null, null, null, null, null, null, LADDER}, LADDER);
        fill(41, item(340, 3, 0), BOOKS, new RemoteItemStack[] {null, null, null}, true);
        fill(40, item(5, 6, 0), PLANKS, new RemoteItemStack[] {null, null, null, null, null, BOOKSHELF}, false);
        finish(40, BOOKSHELF);
    }

    private void craft(int personal, RemoteItemStack ingredient, int[] cells,
            RemoteItemStack[] mid, RemoteItemStack result) throws IOException {
        fill(personal, ingredient, cells, mid, true); finish(personal, result);
    }
