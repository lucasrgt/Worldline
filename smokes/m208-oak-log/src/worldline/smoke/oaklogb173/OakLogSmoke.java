...
public final class OakLogSmoke {
  ...
  public static void main(String[] a) throws Exception {
    if (a.length != 7)
      throw new IllegalArgumentException(
          "usage: OakLogSmoke server.jar workspace port seed username chunkX chunkZ");
    ...
    try {
      ...
      B173PlayerSeed.writeInventory(workspace, user, 4.5D, 60D, 4.5D, new int[] {0, 1},
          new int[] {1, 17}, new int[] {32, 1}, new int[] {0, 0});
      actor.connect();
      actor.synchronizePose();
      require(actor.awaitInventory().occupiedSlots() == 2, "oak log inventory drift");
      ...
      while (
        ...
        require(++column <= 15, "water column exceeded oak log fixture");
      }
      ...
      String trace = "v1|server=official-b1.7.3|seed=" + seed
          + "|fixture=raised-stone+log17:0|cause=packet15-item17:0|wire=packet53-log17:"
          + placed.metadata() + "|oracle=live-block17:0+fresh-login|" + evidence;
      System.out.println("WORLDLINE_M208_LOG=" + evidence);
      System.out.println("WORLDLINE_M208_TRACE=" + trace);
      System.out.println("WORLDLINE_M208_SIGNATURE=" + sha(trace));
    } finally {
      actor.close();
      if (reader != null)
        reader.close();
  ...
  private static BlockPosition foundation(RemoteChunkSnapshot q, int cx, int cz) {
    ...
    throw new IllegalStateException("no deterministic oak log foundation");
  }
