...
/** Removes persistence while preserving vanilla block notifications. */
@SuppressWarnings("rawtypes")
final class FireMemorySaveHandler implements ISaveHandler, IPlayerFileData {
  private final WorldInfo info;
  private final FireMemoryChunkLoader chunks = new FireMemoryChunkLoader();
  FireMemorySaveHandler(long seed, String name) {
