...
public final class RemainingAttachFacesSmoke{
 ...
 private static BlockState wait(B173WireClient a,BlockPosition cell,int id)throws Exception{BlockState placed=null;for(int n=0;n<40&&(placed==null||placed.legacyId()!=id);n++)placed=a.sustainTicks(1).blockAt(cell.x(),cell.y(),cell.z());require(placed!=null&&placed.legacyId()==id,"block "+id+" absent: "+placed);return placed;}
