...
final class RepeaterMemorySaveHandler implements ISaveHandler, IPlayerFileData {
    private final WorldInfo info;
    private final RepeaterMemoryChunkLoader chunks = new RepeaterMemoryChunkLoader();

    RepeaterMemorySaveHandler(long seed, String name) {
