...
final class OracleFireSaveHandler implements om, fl {
    private final ct info;
    private final OracleFireChunkLoader chunks = new OracleFireChunkLoader();

    OracleFireSaveHandler(long seed, String name) {
