...
public final class MultiplayerWireSmoke {
    ...
    public static void main(String[] arguments) throws Exception {
        ...
        try {
            ...
            require(connected.connection() == MultiplayerConnection.CONNECTED
                    && connected.entityId() >= 0 && connected.protocolVersion() == 14, "login state drift");
        ...
        require(client.state().connection() == MultiplayerConnection.DISCONNECTED, "disconnect state drift");
        System.out.println("WORLDLINE_M22_API=server,session,connect,state,players,close");
        System.out.println("WORLDLINE_M22_SOURCE=" + B173WireClient.class.getProtectionDomain()
    ...
    private static void awaitPlayers(MultiplayerServerRuntime server, List<String> expected, long timeout)
