...
final class B173ContainerStep {
    final int windowId, action, slot, button, statisticId, statisticIncrement;
    ...
    B173ContainerStep(int windowId, int action, int slot, RemoteItemStack predicted,
        ...
        this(windowId, action, slot, predicted, before, after, personalBefore, personalAfter,
                cursorBefore, cursorAfter, 0, -1, 0); }
    B173ContainerStep(int windowId, int action, int slot, int button, RemoteItemStack predicted,
            RemoteInventoryView before, RemoteInventoryView after,
            RemoteInventoryView personalBefore, RemoteInventoryView personalAfter,
            RemoteItemStack cursorBefore, RemoteItemStack cursorAfter) {
        this(windowId, action, slot, predicted, before, after, personalBefore, personalAfter,
                cursorBefore, cursorAfter, button, -1, 0); }
    B173ContainerStep(int windowId, int action, int slot, RemoteItemStack predicted,
            RemoteInventoryView before, RemoteInventoryView after,
            RemoteInventoryView personalBefore, RemoteInventoryView personalAfter,
            RemoteItemStack cursorBefore, RemoteItemStack cursorAfter,
        ...
        this(windowId, action, slot, predicted, before, after, personalBefore, personalAfter,
                cursorBefore, cursorAfter, 0, statisticId, statisticIncrement); }
    private B173ContainerStep(int windowId, int action, int slot, RemoteItemStack predicted,
            RemoteInventoryView before, RemoteInventoryView after,
            RemoteInventoryView personalBefore, RemoteInventoryView personalAfter,
            RemoteItemStack cursorBefore, RemoteItemStack cursorAfter,
            int button, int statisticId, int statisticIncrement) {
        this.windowId = windowId; this.action = action; this.slot = slot; this.button = button;
