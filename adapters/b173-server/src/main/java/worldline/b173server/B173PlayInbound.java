...
final class B173PlayInbound {
    ...
    private Correction correction; private int dimension; private long respawnEpoch; private worldline.api.RemoteExplosion explosion; private final B173MobTracker mobs=new B173MobTracker(); private final B173ObjectTracker objects=new B173ObjectTracker(); private final B173BedTracker beds=new B173BedTracker(); private final B173PlayWaits waits=new B173PlayWaits(this);
    ...
    B173ObjectTracker objects() { return objects; } B173BedTracker beds() { return beds; }
