...
/** Single reader for Packet38 and Packet29 shared by combat, dropped items, mobs and paintings. */
final class B173EntityEvents {
    ...
    private final B173PaintingTracker paintings;
    B173EntityEvents(B173CombatTracker combat, B173DroppedItemTracker dropped, B173MobTracker mobs,
            B173PaintingTracker paintings) {
        this.combat = combat; this.dropped = dropped; this.mobs = mobs; this.paintings = paintings;
    }
    ...
    void destroy(DataInputStream input) throws IOException {
        int entity = input.readInt(); dropped.destroy(entity); mobs.destroy(entity); paintings.destroy(entity);
    }
}
