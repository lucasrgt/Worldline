...
/** Controlled single-player ModLoader client boundary for the Worldline TestKit. */
public final class mod_WorldlineTestKitProbe extends BaseMod {
    ...
    public mod_WorldlineTestKitProbe() {
        requireLoader("modloader");
        System.out.println("WORLDLINE_LEGACY_TESTKIT_BOOT=modloader");
    ...
    public boolean OnTickInGame(Minecraft client) {
        ...
        try {
            ...
            if ("CLOSE".equals(command)) {
                ...
                System.out.println("WORLDLINE_LEGACY_TESTKIT_SHUTDOWN=modloader");
    ...
    private void emit(String kind, Minecraft client) throws Exception {
        ...
        output.write(kind + " loader=modloader session=" + property("session")
