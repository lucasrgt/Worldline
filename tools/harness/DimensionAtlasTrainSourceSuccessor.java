...
final class DimensionAtlasTrainSourceSuccessor {
    private static final String[][] SUCCESSORS = {
        ...
        {"tools/harness/MobAiBehaviorCatalogPlacementSuccessor.java",
                "0ad249d166bd154474fb50572a7967d686b95d03ac2878d2ca21058582a363e4",
                "77ce3c96e242ac5562489ba5da46b2faeb276076c2ab32b91847fc3bc4749757"}
    };
    ...
    static void selfTest() {
        for (String[] successor : SUCCESSORS) {
            require(carries(successor[0], successor[1], successor[2]),
                    "dimension Atlas train successor rejected " + successor[0]);
            require(!carries(successor[0], successor[1], "unreviewed"),
                    "dimension Atlas train successor accepted drift " + successor[0]);
        }
        require(!carries("unreviewed", "old", "new"),
                "dimension Atlas train successor allowlist drifted");
